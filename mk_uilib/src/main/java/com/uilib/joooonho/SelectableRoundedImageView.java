...
/*
 * This is Joonho's custom widget.
 * Android ImageView that supports different radii on each corner.
 * You may see the widget at
 *
 *     http://joooonho.com/?p=289
 *
 */

package com.uilib.joooonho;
...
//        if(mDrawable != null)
//            ((SelectableRoundedCornerDrawable)mDrawable).ivTag = (String) getTag();
        super.setImageDrawable(mDrawable);
        updateDrawable();
    }
    ...
    public static class SelectableRoundedCornerDrawable extends Drawable {
        public String ivTag = "";
        private static final String TAG = "SelectRoundedDrawable";
        private static final int DEFAULT_BORDER_COLOR = Color.BLACK;
