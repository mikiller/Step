...
import com.westepper.step.adapters.SystemMessageAdapter;
import com.westepper.step.base.SuperActivity;
import com.westepper.step.customViews.TitleBar;
import com.westepper.step.widgets.SystemMessageViewHolder;
...
public class SystemMessageActivity extends SuperActivity {
    ...
    private void initAdapter() {
        adapter = new SystemMessageAdapter(this,
                ...
                new SystemMessageViewHolder.SystemMessageListener() {
                    @Override
    ...
    private void deleteSystemMessage(final SystemMessage message) {
        ...
        if (message == null) {
            ...
            msgId = R.string.clear_all_success;
        } else {
            NIMClient.getService(SystemMessageService.class).deleteSystemMessage(message.getMessageId());
            msgId = R.string.delete_success;
        }
        items.remove(message);
        refresh();
        Toast.makeText(SystemMessageActivity.this, msgId, Toast.LENGTH_SHORT).show();
    }
