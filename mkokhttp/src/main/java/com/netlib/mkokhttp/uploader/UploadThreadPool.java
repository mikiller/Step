...
import com.netlib.mkokhttp.uploader.internal.ExecutorWithListener;
import com.netlib.mkokhttp.uploader.internal.PriorityBlockingQueue;
...
public class UploadThreadPool {
    ...
    private static class CREATER{
        private static UploadThreadPool instance = new UploadThreadPool();
    }
